...
export declare class PolygonUtils {
    ...
    static outwardEdgeNormal(edge: Edge): any;
    static leftSide: any;
    ...
    static createOffsetEdge(edge: Edge, offset: number[]): any[];
...
export declare function getOffsetPolygon(points: number[][], offset: number): any[];
export {};
