...
export declare const StyledDialogOverlay: import("@stitches/react/types/styled-component").StyledComponent<React.ForwardRefExoticComponent<Dialog.AlertDialogOverlayProps & React.RefAttributes<HTMLDivElement>>, {}, {
    micro: "(max-width: 370px)";
    sm: "(min-width: 640px)";
    md: "(min-width: 768px)";
    lg: "(min-width: 1024px)";
...
export {};
//# sourceMappingURL=PageOptionsDialog.d.ts.map