import { TLBounds, TLTransformInfo, TLPageState } from '@tldraw/core';
import { TDSnapshot, ShapesWithProp, TDShape, TDBinding, TDPage, TldrawCommand, ArrowShape } from '../types';
...
export declare class TLDR {
    ...
    static mutateShapes<T extends TDShape>(data: TDSnapshot, ids: string[], fn: (shape: T, i: number) => Partial<T> | void, pageId: string): {
