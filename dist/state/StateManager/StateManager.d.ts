...
export declare class StateManager<T extends Record<string, any>> {
     ...
     */
    readonly useStore: UseBoundStore<T>;
    /**
     ...
     */
    protected persist: (id?: string | undefined) => void | Promise<void>;
    /**
     ...
     */
    protected cleanup: (nextState: T, prevState: T, patch: Patch<T>, id?: string | undefined) => T;
    /**
     ...
     */
    protected patchState: (patch: Patch<T>, id?: string | undefined) => this;
    /**
     ...
     */
    protected replaceState: (state: T, id?: string | undefined) => this;
    /**
     ...
     */
    onPatch?: (state: T, id?: string) => void;
    /**
     * A callback fired when a patch is applied.
     */
    onCommand?: (state: T, id?: string) => void;
    /**
     * A callback fired when the state is persisted.
     */
    onPersist?: (state: T, id?: string) => void;
    /**
